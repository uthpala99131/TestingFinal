// components/dashboard/Modals/AddSparePartModal.js
...
const AddSparePartModal = ({ onClose, onAdd }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onAdd(formData); // Pass the new spare part data to the parent
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg z-10 w-96">
        <h2 className="text-xl font-bold mb-4">Add New Spare Part</h2>
